...
import TableBody from '@/components/elements/UserTable';
import RoleList from "../components/elements/RoleDropdownList";
import UserList from "../components/elements/UserDropdownList";
...
export default function admin({
    ...
    useEffect(() => {
        setLoading(true)
        const authStatus = true //checkLoggedIn(authService.Roles.admin.toString())
        if (authStatus){
            fetchContent()
            setLoading(false)
        }
                ...
                <div className="flex flex-col">
                    ...
                    <div className="p-1.5 min-w-full inline-block align-middle">
                        ...
                        <div className="px-6 py-4 grid gap-3 md:flex md:items-center border-b border-gray-200 dark:border-gray-700">
                            <form className="px-6 py-4 grid-2 gap-3 md:flex md:items-center border-b border-gray-200 dark:border-gray-700">
                                <UserList />
                                <RoleList />
                        ...
                        <table className={`min-w-full divide-y divide-gray-200 dark:divide-gray-700 `}> {/* ${ data.length ? "" : "hidden"} */}
                            ...
                            <tr>
                                ...
                                <TableBody theadData={getData} tbodyData={data} />
                            {/**
                        ...
                        <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-gray-200 dark:border-gray-700">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                <span className="font-semibold text-gray-800 dark:text-gray-200"></span> results {/* {data.length} */}
                            </p>
                            </div>
