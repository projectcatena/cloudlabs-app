...
export default function Users() {
    return(
        ...
        <DashboardLayout>
        {/* Table Section */}
        <main className="mt-12 px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        {/* Card */}
        <div className="flex flex col">
            
            
            <div className="max-h-screen overflow-x-scroll min-w-full p-1.5 2xl:p-1.5 lg:pl-60 inline-block align middle">
                ...
                {/* Table */}
                <div className="">
                <table className="w-min-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        ...
                        <div className="px-6 py-3">
                            ...
                            <div className="flex w-full h-1.5 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-700">
                                <div className="flex flex-col justify-center overflow-hidden bg-gray-800 dark:bg-gray-200" role="progressbar" style={{"width":"25%"}} aria-valuenow={25} aria-valuemin={0} aria-valuemax={100} />
                            </div>
                            </div>
                        </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <div className="px-6 py-3">
                            ...
                            <div className="flex w-full h-1.5 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-700">
                                <div className="flex flex-col justify-center overflow-hidden bg-gray-800 dark:bg-gray-200" role="progressbar" style={{"width":"78%"}} aria-valuenow={78} aria-valuemin={0} aria-valuemax={100} />
                            </div>
                            </div>
                        </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <div className="pl-6 lg:pl-3 xl:pl-0 pr-6 py-3">
                            ...
                            <span className="inline-flex items-center justify-center h-[2.375rem] w-[2.375rem] rounded-full bg-gray-300 dark:bg-gray-700">
                                <img className="inline-block h-[2.375rem] w-[2.375rem] rounded-full" src="/basicprofilepicture.jpeg" alt="Image Description"></img>
                            </span>
                            <div className="grow">
                        ...
                        <div className="px-6 py-3">
                            ...
                            <div className="flex w-full h-1.5 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-700">
                                <div className="flex flex-col justify-center overflow-hidden bg-gray-800 dark:bg-gray-200" role="progressbar" style={{"width":"100%"}} aria-valuenow={100} aria-valuemin={0} aria-valuemax={100} />
                            </div>
                            </div>
                        </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <div className="px-6 py-3">
                            ...
                            <div className="flex w-full h-1.5 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-700">
                                <div className="flex flex-col justify-center overflow-hidden bg-gray-800 dark:bg-gray-200" role="progressbar" style={{"width":"1%"}} aria-valuenow={1} aria-valuemin={0} aria-valuemax={100} />
                            </div>
                            </div>
                        </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <div className="px-6 py-3">
                            ...
                            <div className="flex w-full h-1.5 bg-gray-200 rounded-full overflow-hidden dark:bg-gray-700">
                                <div className="flex flex-col justify-center overflow-hidden bg-gray-800 dark:bg-gray-200" role="progressbar" style={{"width":"40%"}} aria-valuenow={40} aria-valuemin={0} aria-valuemax={100} />
                            </div>
                            </div>
                        </div>
                        </td>
