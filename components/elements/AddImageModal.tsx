...
const AddImageModal = ({ open, onClose, jwt }: ModalProps) => {
    // Form States
    ...
    async function handleFormSubmit(event: React.SyntheticEvent) {
        ...
        const signedURL = await getSignedUploadURL(fileSelected!.name, setErrorToastOpen, setIsCancel, jwt);
        ...
        if (isXHRSuccess) {
            initVirtualDiskBuild(fileSelected!.name, imageName, setErrorToastOpen, jwt);
                                ...
                                <div className="grid gap-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input onChange={(e) => setImageName(e.target.value)} placeholder="windows-server-2019" type="text" id="imageName" name="imageName" className="py-3 px-4 block w-full border rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400" required aria-describedby="email-error" />
