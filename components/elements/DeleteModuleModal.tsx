...
const DeleteModuleModal = ({open, onClose}: DeleteModuleModalProps) => {
    ...
    useEffect(() => {
        setSelectedModuleId(""); // Reset the selected value when the modal is opened
        fetchModules();
      }, []);
    ...
    async function deleteModule(event: React.SyntheticEvent) {
      ...
      const handleCancel = () => {
        onClose(false);
        setSelectedModuleId(""); // Reset the selected value when cancel button is clicked
      };
                ...
                <div className="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-4 sm:p-10 overflow-y-auto">
                        ...
                        <form id="delete-module-form" onSubmit={deleteModule}>                                     
                            ...
                            <div className="flex justify-end items-center mt-6 mb-0 gap-x-2 py-3 px-4 bg-gray-50 border-t dark:bg-gray-800 dark:border-gray-700">
                                <button type="button" onClick={handleCancel} className="py-2.5 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-gray-800 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800" data-hs-overlay="#hs-notifications">
                                    Cancel
                                </button>
                                <button type="submit" disabled={selectedModuleId == ""} className="py-2.5 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800">
                                    Delete Module
                                </button>
                            </div>
                        </form>    
