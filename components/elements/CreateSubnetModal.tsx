...
const CreateSubnetModal = ({open, onClose}: CreateSubnetModalProps) => {
    ...
    async function createSubnet(event: React.SyntheticEvent) {
            ...
            <div id="add-users" className="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                <div className="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-4 sm:p-10 overflow-y-auto">
                        ...
                        <form id="create-module-form" onSubmit={createSubnet}>
                            <div className="space-y-4">
                                <div>
                                    <div className="flex justify-between items-center">
                                        <label htmlFor="name" className="block text-sm mb-2 dark:text-white">Subnet Name</label>
                                    </div>
                                    ...
                                    <div className="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700">
                                        <label htmlFor="subnetName" className="flex">
                                            ...
                                            placeholder="Enter subnet name: e.g. new-subnet"
                                            required
                                            pattern='^[a-z]([-a-z0-9]*[a-z0-9])$'
                                            title='Please follow RFC 1035 naming convention'></input>
                                        </label>
                                    </div>
                                </div>
