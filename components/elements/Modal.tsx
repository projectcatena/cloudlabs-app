            ...
            <div id="hs-task-created-alert" className="overflow-x-hidden overflow-y-auto">
                <div className="mt-0 opacity-100 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                    ...
                    <div className="p-4 sm:p-10 text-center overflow-y-auto">
                        ...
                        You can see the progress of your task in your <a className="inline-flex items-center gap-x-1.5 text-blue-600 decoration-2 hover:underline font-medium" href="#">personal account.</a> You will be notified of its completion.
                        </p>
