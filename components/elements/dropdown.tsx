    ...
    return (
        <div className="hs-dropdown relative inline-flex">
            ...
            <div className={`${dropdown? 'block': 'hidden'}`}>
                <div className="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] hs-dropdown-open:opacity-100 z-50 opacity-0 w-72 z-10 mt-2 min-w-[15rem] bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700 dark:divide-gray-700" aria-labelledby="hs-dropdown-default">
