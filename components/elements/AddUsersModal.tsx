...
const AddUsersModal = ({open, onClose}: ModalProps) => {
    if (!open) return null;

    return(
        <div id="add-users" className="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto">
            <div id="add-users" className="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto">
                    ...
                    <div className="p-4 sm:p-10 overflow-y-auto">
                        <div className="mb-6 text-center">
                            ...
                            <p className="text-gray-500">
                                Enter the email addresses of users who can register for this module
                            </p>
                        </div>
                        ...
                        <form>
                            <div className="space-y-4">
                                <div className="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700">
                                    <label htmlFor="email-list" className="flex">
                                        <textarea id="email-list" placeholder="student1@gmail.com" className="py-3 px-4 block w-full h-60 border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-inherit dark:border-gray-700 dark:text-gray-400"></textarea>
                                    </label>
                                </div>
                            </div>
                        </form>
