...
export default function VirtualMachineCard({ computeInstance, jwt }: VirtualMachineCardProps) {
    return (
        <div className="group flex flex-col h-full bg-white border border-gray-200 shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
            ...
            <div className="mt-auto flex border-t border-gray-200 divide-x divide-gray-200 dark:border-gray-700 dark:divide-gray-700 z-0">
                ...
                <Dropdown jwt={jwt} instanceName={computeInstance.instanceName}></Dropdown>
            </div>
        </div>
    )
}
